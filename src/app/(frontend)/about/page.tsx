      ...
      <main>
        <section className="max-w-2xl mx-auto px-5 sm:px-8 pt-12 sm:pt-16 pb-8">
          ...
          <p className="text-ink/70 sm:text-lg leading-relaxed">
            ...
            догляд: готові добірки, покрокові плани та прості пояснення, без потреби розбиратися
        ...
        <section className="max-w-2xl mx-auto px-5 sm:px-8 py-6 sm:py-8 space-y-4">
          ...
          <p className="text-ink/70 leading-relaxed">
            ...
            сайт існує, щоб швидко показати підходящу добірку чи план замість того, щоб змушувати
        ...
        <section className="max-w-2xl mx-auto px-5 sm:px-8 py-6 sm:py-8 space-y-4">
          ...
          <p className="text-ink/70 leading-relaxed">
            ...
            догляд») або вибір за потребою веде до вже готової добірки чи плану. Це не
